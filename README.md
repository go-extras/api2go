...
[![GoDoc](https://godoc.org/github.com/go-extras/api2go?status.svg)](https://godoc.org/github.com/go-extras/api2go)
...
```go
go get github.com/go-extras/api2go
```
...
- Basic Examples can be found [here](https://github.com/go-extras/api2go/blob/master/examples/crud_example.go).
...
can directly use our sub-package `github.com/go-extras/api2go/jsonapi` 
...
```go get -tags=gingonic github.com/go-extras/api2go```
